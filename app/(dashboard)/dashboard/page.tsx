    ...
    return (
        <div className="p-6 space-y-6 animate-fade-in">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="card-hover border-success/50 bg-gradient-to-br from-success/5 to-transparent">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold flex items-center gap-2">
                            {stats.completed} <CheckCircle2 className="h-6 w-6 text-success" />
                        </div>
                        <p className="text-xs text-muted-foreground mt-1">
                            Milestones reached
                        </p>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    {/* Motivational Quote */}
                    <Card className="border-primary/20 bg-gradient-to-br from-primary-50/50 to-secondary-50/50 dark:bg-slate-900/50 dark:from-slate-900/50 dark:to-slate-800/50">
                        <CardHeader>
                            <CardTitle className="text-base dark:text-white">Daily Motivation</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-sm italic text-foreground dark:text-slate-100">&quot;{quote}&quot;</p>
                        </CardContent>
                    </Card>
